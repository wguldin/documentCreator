	    ...
	    return _react2['default'].createElement(
	      'button',
	      {
	        className: (0, _classnames2['default'])('ReactTabs__Tab', this.props.className, {
	          'ReactTabs__Tab--selected btn btn-primary': this.props.selected,
			  'ReactTabs__Tab--selected btn btn-default': !this.props.selected,
	          'ReactTabs__Tab--disabled btn': this.props.disabled
	        }),
	        role: 'tab',
	        id: this.props.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2['default'].createClass({
	  ...
	  //TODO: Need to add another element here with text center on it.
	  render: function render() {
	    return _react2['default'].createElement(
	      'div',
	      {
	        className: (0, _classnames2['default'])('ReactTabs__TabList btn-group', this.props.className),
	        role: 'tablist'
	      },
	      this.props.children
	    );
